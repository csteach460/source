/*
* getters and setters - basic - object computed property - test2.js
...
function Planets() {
	...
	// add method to instantiated object - return computed details for specified planet
	this.getPlanet = (name) => {
		if (_names.includes(name)) {
			...
			const planetDetails = {
				name: name,
				codes: {
					iau: _codes['iau'][index],
					unicode: _codes['unicode'][index],
				}
			}
			return planetDetails;
		}
...
console.log('computed value = ', planets.getPlanet('earth'));
